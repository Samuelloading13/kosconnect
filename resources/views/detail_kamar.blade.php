<x-guest-layout>
    <div class="py-12 bg-gray-50 min-h-screen">
        <div class="w-full mx-auto px-4 lg:px-8">
            ...
            <div class="bg-white shadow-lg sm:rounded-2xl flex flex-col md:flex-row gap-10 p-6 md:p-10 w-full max-w-6xl mx-auto">

                <!-- Kolom Kiri: Gambar & Info -->
                <div class="md:basis-1/2 w-full p-6 md:p-8 md:border-r border-gray-100">
                    <div class="w-full h-64 rounded-xl overflow-hidden mb-6 bg-gray-100 flex items-center justify-center">
                        @if ($kamar->foto)
                            <img src="{{ asset('storage/' . $kamar->foto) }}" alt="Foto Kamar {{ $kamar->nama_kamar }}" class="w-full h-full object-cover">
                        @else
                ...
                <div class="md:basis-1/2 w-full p-6 md:p-8 bg-gray-50 flex flex-col justify-center">
